...
export const NAV_ROUTES = {
    ...
    HORSE_REQUEST: `/${NAV_MODULE_NAME}/${NAV_SUB_ROUTES.REQUEST}/${NAV_EVENT_SUB_ROUTES.HORSE}`,
    RIDER_REQUEST: `/${NAV_MODULE_NAME}/${NAV_SUB_ROUTES.REQUEST}/${NAV_EVENT_SUB_ROUTES.RIDER}`,
